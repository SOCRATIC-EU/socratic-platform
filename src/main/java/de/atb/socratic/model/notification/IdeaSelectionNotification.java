...
import de.atb.socratic.web.components.navbar.notifications.UpdateIdeaSelectionNotificationLink;
...
@DiscriminatorValue(value = "ISN")
public class IdeaSelectionNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public IdeaSelectionNotification() {
        this.setNotificationType(NotificationType.IDEA_SELECTION_LEADER_UPDATE);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UpdateIdeaSelectionNotificationLink(id, (IModel<IdeaSelectionNotification>) model);
    }
