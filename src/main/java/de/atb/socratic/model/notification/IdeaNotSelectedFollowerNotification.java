...
import de.atb.socratic.web.components.navbar.notifications.UpdateIdeaNotSelectedFollowerNotificationLink;
...
@DiscriminatorValue(value = "INSFN")
public class IdeaNotSelectedFollowerNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public IdeaNotSelectedFollowerNotification() {
        this.setNotificationType(NotificationType.IDEA_NOT_SELECTION_FOLLOWER_UPDATE);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UpdateIdeaNotSelectedFollowerNotificationLink(id, (IModel<IdeaNotSelectedFollowerNotification>) model);
    }
