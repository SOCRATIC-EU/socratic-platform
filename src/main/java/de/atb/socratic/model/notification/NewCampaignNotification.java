...
import de.atb.socratic.web.components.navbar.notifications.NewCampaignNotificationLink;
...
@DiscriminatorValue(value = "NCN")
public class NewCampaignNotification extends Notification {

    private static final long serialVersionUID = -105225851072942368L;

    public NewCampaignNotification() {
        this.setNotificationType(NotificationType.CAMPAIGN_NEW);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id, IModel<N> model) {
        return (T) new NewCampaignNotificationLink(id, (IModel<NewCampaignNotification>) model);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
        ...
        return (T) new NewCampaignNotificationLink(id, parameters, (IModel<NewCampaignNotification>) model);
    }
