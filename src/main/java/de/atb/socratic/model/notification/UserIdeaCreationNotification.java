...
import de.atb.socratic.web.components.navbar.notifications.UserIdeaCreationNotificationLink;
...
@DiscriminatorValue(value = "UICN")
public class UserIdeaCreationNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public UserIdeaCreationNotification() {
        this.setNotificationType(NotificationType.IDEA_CREATED);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UserIdeaCreationNotificationLink(id, (IModel<UserIdeaCreationNotification>) model);
    }
    ...
    public void setParameters(Query q) {
        ...
        q.setParameter("dType", "UICN"); // this should match @DiscriminatorValue on top of this class
    }
