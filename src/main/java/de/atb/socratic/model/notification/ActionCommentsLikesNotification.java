...
import de.atb.socratic.web.components.navbar.notifications.ActionCommentsLikesNotificationLink;
...
@DiscriminatorValue(value = "ACLN")
public class ActionCommentsLikesNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public ActionCommentsLikesNotification() {
        this.setNotificationType(NotificationType.ACTION_COMMENTS_LIKES);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new ActionCommentsLikesNotificationLink(id, (IModel<ActionCommentsLikesNotification>) model);
    }
