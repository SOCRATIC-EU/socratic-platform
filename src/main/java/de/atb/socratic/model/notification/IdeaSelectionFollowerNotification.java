...
import de.atb.socratic.web.components.navbar.notifications.UpdateIdeaSelectionFollowerNotificationLink;
...
@DiscriminatorValue(value = "ISFN")
public class IdeaSelectionFollowerNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public IdeaSelectionFollowerNotification() {
        this.setNotificationType(NotificationType.IDEA_SELECTION_FOLLOWER_UPDATE);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UpdateIdeaSelectionFollowerNotificationLink(id, (IModel<IdeaSelectionFollowerNotification>) model);
    }
