...
import de.atb.socratic.web.components.navbar.notifications.UserSkillsOrInterestsUpdateNotificationLink;
...
@DiscriminatorValue(value = "USIUN")
public class UserSkillsOrInterestsUpdateNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public UserSkillsOrInterestsUpdateNotification() {
        this.setNotificationType(NotificationType.USER_SKILLS_INTEREST);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UserSkillsOrInterestsUpdateNotificationLink(id, (IModel<UserSkillsOrInterestsUpdateNotification>) model);
    }
