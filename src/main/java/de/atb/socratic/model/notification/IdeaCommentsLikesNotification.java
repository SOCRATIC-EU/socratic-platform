...
import de.atb.socratic.web.components.navbar.notifications.IdeaCommentsLikesNotificationLink;
...
@DiscriminatorValue(value = "ICLN")
public class IdeaCommentsLikesNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public IdeaCommentsLikesNotification() {
        this.setNotificationType(NotificationType.IDEA_COMMENTS_LIKES);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new IdeaCommentsLikesNotificationLink(id, (IModel<IdeaCommentsLikesNotification>) model);
    }
