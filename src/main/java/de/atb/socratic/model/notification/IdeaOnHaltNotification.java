...
import de.atb.socratic.web.components.navbar.notifications.UpdateIdeaOnHaltNotificationLink;
...
@DiscriminatorValue(value = "IOHN")
public class IdeaOnHaltNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public IdeaOnHaltNotification() {
        this.setNotificationType(NotificationType.IDEA_ON_HALT_LEADER_UPDATE);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UpdateIdeaOnHaltNotificationLink(id, (IModel<IdeaOnHaltNotification>) model);
    }
