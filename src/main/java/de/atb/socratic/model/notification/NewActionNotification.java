...
import de.atb.socratic.web.components.navbar.notifications.NewActionNotificationLink;
...
@DiscriminatorValue(value = "NAN")
public class NewActionNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public NewActionNotification() {
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new NewActionNotificationLink(id, (IModel<NewActionNotification>) model);
    }
