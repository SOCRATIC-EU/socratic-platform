...
import de.atb.socratic.web.components.navbar.notifications.UserActionFollowerNotificationLink;
...
@DiscriminatorValue(value = "UAFN")
public class UserActionFollowerNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public UserActionFollowerNotification() {
        this.setNotificationType(NotificationType.ACTION_FOLLOWED);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UserActionFollowerNotificationLink(id, (IModel<UserActionFollowerNotification>) model);
    }
    ...
    public void setParameters(Query q) {
        ...
        q.setParameter("dType", "UAFN"); // this should match @DiscriminatorValue on top of this class
    }
