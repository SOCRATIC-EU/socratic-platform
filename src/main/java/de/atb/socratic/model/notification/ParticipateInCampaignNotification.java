...
import de.atb.socratic.web.components.navbar.notifications.ParticipateInCampaignNotificationLink;
import org.apache.wicket.Page;
import org.apache.wicket.model.IModel;
import org.apache.wicket.request.mapper.parameter.PageParameters;

/**
 * ParticipateInCampaignNotification
 *
 * @author ATB
...
@DiscriminatorValue(value = "PICN")
public class ParticipateInCampaignNotification extends Notification {

    private static final long serialVersionUID = -105225851072942368L;

    public ParticipateInCampaignNotification() {
        this.setNotificationType(NotificationType.CAMPAIGN_PARTICIPATE);
    }
     ...
     * (non-Javadoc)
     *
     * @see de.atb.socratic.model.notification.Notification#getLink(java.lang.String,
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id, IModel<N> model) {
        return (T) new ParticipateInCampaignNotificationLink(id, (IModel<ParticipateInCampaignNotification>) model);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
        ...
        return (T) new ParticipateInCampaignNotificationLink(id, parameters, (IModel<ParticipateInCampaignNotification>) model);
    }
