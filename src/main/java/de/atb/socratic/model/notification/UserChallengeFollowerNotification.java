...
import de.atb.socratic.web.components.navbar.notifications.UserChallengeFollowerNotificationLink;
...
@DiscriminatorValue(value = "UCFN")
public class UserChallengeFollowerNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public UserChallengeFollowerNotification(NotificationType notificationType) {
        this.setNotificationType(notificationType);
    }

    public UserChallengeFollowerNotification() {
    }
    ...
    /**
     * @param campaign a campaign to set
     */
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UserChallengeFollowerNotificationLink(id, (IModel<UserChallengeFollowerNotification>) model);
    }
    ...
    public void setParameters(Query q) {
        ...
        q.setParameter("dType", "UCFN"); // this should match @DiscriminatorValue on top of this class
    }
