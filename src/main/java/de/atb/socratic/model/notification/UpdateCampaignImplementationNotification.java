...
import de.atb.socratic.web.components.navbar.notifications.UpdateCampaignImplementationNotificationLink;
...
@DiscriminatorValue(value = "UCImN")
public class UpdateCampaignImplementationNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public UpdateCampaignImplementationNotification() {
        this.setNotificationType(NotificationType.CAMPAIGN_UPDATE_IMPLEMENTATION);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UpdateCampaignImplementationNotificationLink(id,
    ...
    public void setParameters(Query q) {
        ...
        q.setParameter("dType", "UCImN"); // this should match @DiscriminatorValue on top of this class
    }
