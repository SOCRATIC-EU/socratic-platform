...
import de.atb.socratic.web.components.navbar.notifications.CampaignCommentsLikesNotificationLink;
...
@DiscriminatorValue(value = "CCLN")
public class CampaignCommentsLikesNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public CampaignCommentsLikesNotification() {
        this.setNotificationType(NotificationType.CAMPAIGN_COMMENTS_LIKES);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new CampaignCommentsLikesNotificationLink(id, (IModel<CampaignCommentsLikesNotification>) model);
    }
