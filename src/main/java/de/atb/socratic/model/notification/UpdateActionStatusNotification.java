...
import de.atb.socratic.web.components.navbar.notifications.UpdateActionStatusNotificationLink;
...
@DiscriminatorValue(value = "UASN")
public class UpdateActionStatusNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public UpdateActionStatusNotification() {
        this.setNotificationType(NotificationType.ACTION_STATUS_UPDATE);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UpdateActionStatusNotificationLink(id, (IModel<UpdateActionStatusNotification>) model);
    }
