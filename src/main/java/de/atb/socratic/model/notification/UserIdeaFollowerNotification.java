...
import de.atb.socratic.web.components.navbar.notifications.UserIdeaFollowerNotificationLink;
...
@DiscriminatorValue(value = "UIFN")
public class UserIdeaFollowerNotification extends Notification {

    private static final long serialVersionUID = 3448302761918945194L;

    public UserIdeaFollowerNotification() {
        this.setNotificationType(NotificationType.IDEA_FOLLOWED);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id,
                                                                                                             IModel<N> model) {
        return (T) new UserIdeaFollowerNotificationLink(id, (IModel<UserIdeaFollowerNotification>) model);
    }
    ...
    public void setParameters(Query q) {
        ...
        q.setParameter("dType", "UIFN"); // this should match @DiscriminatorValue on top of this class
    }
