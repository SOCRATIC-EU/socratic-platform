...
import de.atb.socratic.web.components.navbar.notifications.UpdateActionNotificationLink;
...
public class UpdateActionNotification extends Notification {


    private static final long serialVersionUID = 3448302761918945194L;

    public UpdateActionNotification() {
        this.setNotificationType(NotificationType.ACTION_UPDATE);
    }
    ...
    public <N extends Notification, P extends Page, T extends NotificationBookmarkablePageLink<N>> T getLink(String id, IModel<N> model) {
        return (T) new UpdateActionNotificationLink(id, (IModel<UpdateActionNotification>) model);
    }
