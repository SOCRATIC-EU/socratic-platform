...
public class AdminActionShowAllPage extends Dashboard {
    ...
    private static final int actionsPerPage = 9;
    ...
    public AdminActionShowAllPage(final PageParameters parameters) {
        super(parameters);
        ...
        actionListPanel = new ActionListPanel("actionsList", Model.of(loggedInUser), feedbackPanel, state, actionsPerPage) {
        ...
        final DropDownChoice<EntitiySortingCriteria> sortingCriteriaChoice = new DropDownChoice<>(wicketId,
                ...
                new IChoiceRenderer<EntitiySortingCriteria>() {
                    ...
                    public Object getDisplayValue(EntitiySortingCriteria object) {
                        return new StringResourceModel(object.getKey(), AdminActionShowAllPage.this, null).getString();
                    }
