...
public abstract class AdminActionTeamPanel extends GenericPanel<Action> {
    ...
    public AdminActionTeamPanel(final String id, final IModel<Action> model, final StyledFeedbackPanel feedbackPanel) {
        super(id, model);
        ...
        participantsContainer = new WebMarkupContainer("teamMembersContainer");
        ...
        participantsRepeater = new DataView<User>("teamMembersRepeater", participantProvider, itemsPerPage) {
            ...
            protected void populateItem(Item<User> item) {
                ...
                AdminActionTeamPanel.this.populateItem(item, item.getModelObject());
            }
        };
    ...
    protected void populateItem(final WebMarkupContainer item, User user) {
        ...
        item.add(newDeleteFronTeamLink(user));
    }
        ...
        AjaxSubmitLink ajaxSubmitLink = new AjaxSubmitLink("createMessage") {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                ...
                if (messageParticipantsSortingCriteria.getModelObject().equals(MessageParticipantsSortingCriteria.All_Users)) {
                    recipients = actionService.getAllTeamMembersByAscFirstNameAndByAction(action);
    ...
    private DropDownChoice<MessageParticipantsSortingCriteria> newSortingCriteriaDropDownChoice() {
        ...
        final DropDownChoice<MessageParticipantsSortingCriteria> sortingCriteriaChoice = new DropDownChoice<MessageParticipantsSortingCriteria>(
            ...
            public Object getDisplayValue(MessageParticipantsSortingCriteria object) {
                return new StringResourceModel(object.getNameKey(), AdminActionTeamPanel.this, null).getString();
            }
     ...
     * @return
     */
    private AjaxLink<Void> newDeleteFronTeamLink(final User user) {
        final AjaxLink<Void> deleteLink = new AjaxLink<Void>("deleteLink") {
            private static final long serialVersionUID = 1L;

            @Override
            protected void onConfigure() {
                super.onConfigure();
                this.add(new AttributeModifier("value", new StringResourceModel("iteration.delete.Label", this, null)
                        .getString()));
            }
    ...
    private final class UserProvider extends EntityProvider<User> {
        ...
        public Iterator<? extends User> iterator(long first, long count) {
            ...
            users = actionService.getAllTeamMembersByAscFirstNameAndByAction(action, Long.valueOf(first).intValue(), Long
