 ...
 * @author ATB
 */
public class CoordinatorDashboardMessagesPage extends DashboardCommonHeaderPage {
    ...
    public CoordinatorDashboardMessagesPage(final PageParameters parameters) {
        super(parameters);
        ...
        add(new AjaxLink<Void>("inbox") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                setResponsePage(CoordinatorDashboardMessagesInboxPage.class, new PageParameters());
            }
        });
        ...
        add(new AjaxLink<Void>("sent") {
            ...
            public void onClick(AjaxRequestTarget target) {
                add(new AttributeModifier("class", "active"));
                setResponsePage(CoordinatorDashboardMessagesSentPage.class, new PageParameters());
            }
        });
    }
