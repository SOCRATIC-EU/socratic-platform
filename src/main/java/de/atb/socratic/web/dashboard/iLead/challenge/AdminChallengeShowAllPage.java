...
public class AdminChallengeShowAllPage extends Dashboard {
    ...
    private static final int challengesPerPage = 9;
    ...
    public AdminChallengeShowAllPage(final PageParameters parameters) {
        super(parameters);
        ...
        challengeListPanel = new ChallengeListPanel("challengesList", Model.of(loggedInUser), feedbackPanel, state,
                challengesPerPage) {
        ...
        final DropDownChoice<EntitiySortingCriteria> sortingCriteriaChoice = new DropDownChoice<>(
                ...
                new IChoiceRenderer<EntitiySortingCriteria>() {
                    ...
                    public Object getDisplayValue(EntitiySortingCriteria object) {
                        return new StringResourceModel(object.getKey(), AdminChallengeShowAllPage.this, null).getString();
                    }
