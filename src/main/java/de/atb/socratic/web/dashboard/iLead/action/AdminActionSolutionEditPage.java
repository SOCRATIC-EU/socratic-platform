...
public class AdminActionSolutionEditPage extends AdminAction {
    ...
    public AdminActionSolutionEditPage(PageParameters parameters) {
        super(parameters);
    ...
    protected void save(AjaxRequestTarget target) {
        ...
        setResponsePage(ActionSolutionPage.class,
                new PageParameters().set("id", theAction.getId()));
    }
    ...
    private void updateActionFromForm(AjaxRequestTarget target) {
        ...
        // one can not reinitialize Set, so clear it and then assign new values    
        theAction.getAttachments().clear();
        theAction.getAttachments().addAll(actionSupportingDocFileUploadInfo.getFileInfos(actionSupportingDocUploadHiddenField.getModelObject()));
