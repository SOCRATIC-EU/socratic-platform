...
public abstract class DeleteUserNotificationModal extends NotificationModal {

    private static final long serialVersionUID = -3095966901995207916L;

    public DeleteUserNotificationModal(String id, IModel<String> headerModel, IModel<String> messageModel,
    ...
    public abstract void deleteUserClicked(AjaxRequestTarget target);
