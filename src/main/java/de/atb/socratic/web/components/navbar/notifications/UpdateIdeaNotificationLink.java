 ...
 */
public class UpdateIdeaNotificationLink extends NotificationBookmarkablePageLink<UpdateIdeaNotification> {

    private static final long serialVersionUID = 6341070512879577697L;

    public UpdateIdeaNotificationLink(String id, IModel<UpdateIdeaNotification> model) {
        this(id, new PageParameters(), model);
    }

    public UpdateIdeaNotificationLink(String id, PageParameters parameters, IModel<UpdateIdeaNotification> model) {
