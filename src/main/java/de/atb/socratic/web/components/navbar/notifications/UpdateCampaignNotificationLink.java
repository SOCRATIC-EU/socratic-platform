 ...
 * @author ATB.
 */
public class UpdateCampaignNotificationLink extends NotificationBookmarkablePageLink<UpdateCampaignNotification> {

    private static final long serialVersionUID = -3687349718251374845L;

    public UpdateCampaignNotificationLink(String id, IModel<UpdateCampaignNotification> model) {
        this(id, new PageParameters(), model);
    }

    public UpdateCampaignNotificationLink(String id, PageParameters parameters, IModel<UpdateCampaignNotification> model) {
