 ...
 */
public class NewActionNotificationLink extends NotificationBookmarkablePageLink<NewActionNotification> {

    private static final long serialVersionUID = -3687349718251374845L;

    public NewActionNotificationLink(String id, IModel<NewActionNotification> model) {
        this(id, new PageParameters(), model);
    }

    public NewActionNotificationLink(String id, PageParameters parameters, IModel<NewActionNotification> model) {
        ...
        add(new Label("ideaName", getAction().getIdea().getShortText())); // get idea name
    }
