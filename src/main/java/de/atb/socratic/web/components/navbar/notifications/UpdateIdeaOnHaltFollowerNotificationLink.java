 ...
 * @author ATB
 */
public class UpdateIdeaOnHaltFollowerNotificationLink extends NotificationBookmarkablePageLink<IdeaOnHaltFollowerNotification> {

    private static final long serialVersionUID = -6847965169284935767L;

    public UpdateIdeaOnHaltFollowerNotificationLink(String id, IModel<IdeaOnHaltFollowerNotification> model) {
        this(id, new PageParameters(), model);
    }

    public UpdateIdeaOnHaltFollowerNotificationLink(String id, PageParameters parameters, IModel<IdeaOnHaltFollowerNotification> model) {
