 ...
 * @author ATB.
 */
public class IdeaCommentsLikesNotificationLink extends NotificationBookmarkablePageLink<IdeaCommentsLikesNotification> {

    private static final long serialVersionUID = -3687349718251374845L;

    public IdeaCommentsLikesNotificationLink(String id, IModel<IdeaCommentsLikesNotification> model) {
        this(id, new PageParameters(), model);
    }

    public IdeaCommentsLikesNotificationLink(String id, PageParameters parameters, IModel<IdeaCommentsLikesNotification> model) {
