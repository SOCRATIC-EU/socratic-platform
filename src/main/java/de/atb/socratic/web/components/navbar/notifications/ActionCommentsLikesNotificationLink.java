 ...
 * @author ATB.
 */
public class ActionCommentsLikesNotificationLink extends NotificationBookmarkablePageLink<ActionCommentsLikesNotification> {

    private static final long serialVersionUID = -3687349718251374845L;

    public ActionCommentsLikesNotificationLink(String id, IModel<ActionCommentsLikesNotification> model) {
        this(id, new PageParameters(), model);
    }

    public ActionCommentsLikesNotificationLink(String id, PageParameters parameters, IModel<ActionCommentsLikesNotification> model) {
