 ...
 * @author ATB
 */
public class UpdateIdeaNotSelectedFollowerNotificationLink extends
        NotificationBookmarkablePageLink<IdeaNotSelectedFollowerNotification> {

    private static final long serialVersionUID = -6847965169284935767L;

    public UpdateIdeaNotSelectedFollowerNotificationLink(String id, IModel<IdeaNotSelectedFollowerNotification> model) {
        this(id, new PageParameters(), model);
    }

    public UpdateIdeaNotSelectedFollowerNotificationLink(String id, PageParameters parameters,
                                                         IModel<IdeaNotSelectedFollowerNotification> model) {
