...
public abstract class ShareOnLinkedInNotificationModel extends NotificationModal {

    private static final long serialVersionUID = -3095966901995207916L;

    public ShareOnLinkedInNotificationModel(String id, IModel<String> headerModel, IModel<String> messageModel,
    ...
    public abstract void shareOnLIButtonClicked(AjaxRequestTarget target);
