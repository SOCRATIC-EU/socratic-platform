 ...
 * @author ATB
 */
public class UpdateIdeaNotSelectedNotificationLink extends NotificationBookmarkablePageLink<IdeaNotSelectedNotification> {

    private static final long serialVersionUID = -6847965169284935767L;

    public UpdateIdeaNotSelectedNotificationLink(String id, IModel<IdeaNotSelectedNotification> model) {
        this(id, new PageParameters(), model);
    }

    public UpdateIdeaNotSelectedNotificationLink(String id, PageParameters parameters, IModel<IdeaNotSelectedNotification> model) {
