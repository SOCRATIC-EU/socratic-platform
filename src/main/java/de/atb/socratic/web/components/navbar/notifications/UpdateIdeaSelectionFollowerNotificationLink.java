...
/**
 * This class is used for notification of Idea's selection for becoming an action. Notification will be sent to Idea and
 * Campaign Followers indicating that idea is selected by CO.
 *
 * @author ATB
 */
public class UpdateIdeaSelectionFollowerNotificationLink extends
        NotificationBookmarkablePageLink<IdeaSelectionFollowerNotification> {

    private static final long serialVersionUID = -6847965169284935767L;

    public UpdateIdeaSelectionFollowerNotificationLink(String id, IModel<IdeaSelectionFollowerNotification> model) {
        this(id, new PageParameters(), model);
    }

    public UpdateIdeaSelectionFollowerNotificationLink(String id, PageParameters parameters,
                                                       IModel<IdeaSelectionFollowerNotification> model) {
