...
/**
 * This class is used for notification of user following Idea.
 *
 * @author ATB
 */
public class UserIdeaFollowerNotificationLink extends NotificationBookmarkablePageLink<UserIdeaFollowerNotification> {

    private static final long serialVersionUID = -6847965169284935767L;

    public UserIdeaFollowerNotificationLink(String id, IModel<UserIdeaFollowerNotification> model) {
        this(id, new PageParameters(), model);
    }

    public UserIdeaFollowerNotificationLink(String id, PageParameters parameters, IModel<UserIdeaFollowerNotification> model) {
