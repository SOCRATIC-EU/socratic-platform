...
public abstract class FacebookAjaxSignInPanel extends Panel {
    ...
    private static final JavaScriptResourceReference MYFACEBOOKPAGE_JS = new JavaScriptResourceReference(FacebookAjaxSignInPanel.class, "facebook.js");

    public FacebookAjaxSignInPanel(String id, final StyledFeedbackPanel feedbackPanel) {
        super(id);

        add(new Label("facebook-login"));
        ...
        AbstractDefaultAjaxBehavior ajaxCallBack = new AbstractDefaultAjaxBehavior() {
            ...
            protected void respond(AjaxRequestTarget target) {
                try {
                    ...
                    if (token.isNull() || token.isEmpty() || !CSRF_Token.equals(token.toString())) {
                        ...
                        FacebookProfile profile = FacebookProfile.fromJSONString(getRequest().getRequestParameters().getParameterValue("profile").toString());
            ...
            public void renderHead(Component component,
                ...
                response.render(new OnEventHeaderItem("window", "facebooklogincomplete", getCallbackScript()));
            }
    ...
    public abstract void authenticate(final FacebookProfile profile, final AjaxRequestTarget target) throws Exception;
