...
public class ActionIterationsListPanel extends Panel {
     ...
     * @param feedbackPanel
     */
    public ActionIterationsListPanel(final String id, final Action action, final StyledFeedbackPanel feedbackPanel) {
        super(id);
        ...
        iterationsRepeater = new DataView<ActionIteration>("iterations", iterationProvider, itemsPerPage) {
            ...
            protected void populateItem(Item<ActionIteration> item) {
                ...
                ActionIterationsListPanel.this.populateItem(item, item.getModelObject());
            }
        };
     ...
     * @return
     */
    private BookmarkablePageLink<ActionIterationDetailPage> newActionIterationDetailPageLink(PageParameters parameter) {
        final BookmarkablePageLink<ActionIterationDetailPage> exploreContactLink = new BookmarkablePageLink<ActionIterationDetailPage>(
                "exploreContactLink", ActionIterationDetailPage.class, parameter) {
            private static final long serialVersionUID = 1L;
        };
    ...
    protected void populateItem(final WebMarkupContainer item, final ActionIteration iteration) {
        ...
        item.add(new Label("callToAction", new PropertyModel<String>(theAction, "callToAction")));
        item.add(newActionIterationDetailPageLink(new PageParameters().set("iterationId", iteration.getId()).set("id",
                theAction.getId())));
